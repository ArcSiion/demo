...
int main(int argc, char* argv[]) {
	...
	run_and_test(blocking_parallel_rectangle_vectime, A);
	run_and_test(blocking_parallel_rectangle_vectime_extra_array, A);
	run_and_test(blocking_parallel_rectangle_vectime_512, A);
	run_and_test(blocking_parallel_rectangle_vectime_512_hybrid, A);
	run_and_test(blocking_parallel_rectangle_vectime_extra_array_512, A);
	run_and_test(blocking_parallel_rectangle_vectime_extra_array_512_hybrid, A);
