...
void blocking_parallel_rectangle_scalar(double * B, int NX, int NY, int T, int xb, int yb, int tb);
void blocking_parallel_rectangle_vector(double * B, int NX, int NY, int T, int xb, int yb, int tb);
void blocking_parallel_rectangle_vectime(double * B, int NX, int NY, int T, int xb, int yb, int tb);
void blocking_parallel_rectangle_vectime_extra_array(double * B, int NX, int NY, int T, int xb, int yb, int tb);
